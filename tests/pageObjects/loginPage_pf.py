...
class LoginPage(PageFactory):    # Single Inheritance
    # WebDriver Initialization
    def __init__(self, driver):
        self.driver = driver


    # Keep the locators in Dictionary Format of tuples
    locators = {
    ...
    def login_to_vwo(self, user, pwd):
        self.username.set_text(user)    # inbuilt function - so no need to use page actions and all
